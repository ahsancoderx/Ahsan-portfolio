...
export const PROJECTS = [
...

  {
    ...
    subtitle: 'Free Resuma builder',
    description: 'A full-stack resume builder that lets users create, preview, and download professional CVs. It includes an ATS score checker for optimization and a built-in PDF converter for easy export. Built with Nextjs and MatarialUI CSS for a fast, responsive experience.',
    category: 'SaaS', featured: true,
    image: '/project-pic/cvstudio1.png',
    fallbackColor: 'linear-gradient(135deg,#0a0a1a 0%,#0d0d2d 50%,#060615 100%)',
    tags: ['Next.js', 'javascript', 'Material ui'],
    liveUrl: 'https://cvstudio-six.vercel.app/',
    githubUrl: 'https://github.com/ahsancoderx/cvforge',
    videoUrl: null, year: '2026', status: 'Live',
  },
  {

...
export const PROJECTS = [
  {
    ...
    category: 'Full-Stack',
    featured: true,
    image: '/project-pic/E-commrce store.png',    // replace with your image
    ...
    videoUrl:  '<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7392455375322644480?compact=1" height="399" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>',
    year: '2025',
    status: 'Live',
  },
  {
    ...
    description: 'A modern full-stack SkillReel platform developed using Next.js and Node.js, focused on delivering a seamless experience for showcasing digital skills. Integrated with NextAuth for secure authentication and Cloudinary for efficient media management, the application ensures performance and scalability. With a clean and responsive interface built using Material UI, users can easily create, manage, and present their skill-based content in a professional and engaging way.',
    featured: true,
    image: '/project-pic/Aliskill.png',
    fallbackColor: 'linear-gradient(135deg,#050f1a 0%,#0d1f2d 50%,#071525 100%)',
    tags: ['Nextjs', 'Node.js', 'Cloudinary', 'NaxtAuth', 'Matrial UI'],
    liveUrl:   'https://github.com/ahsancoderx/social-media-project',
    githubUrl: 'https://github.com/ahsancoderx/social-media-project',
    videoUrl:  '<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7437745460322373632?compact=1" height="399" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>',
    year: '2025',
    status: 'Live',
  },
  {
    ...
    description: 'A full-stack dental clinic appointment system built with React.js, Tailwind CSS, and Email.js. The platform allows patients to easily book appointments online, while enabling the clinic to manage schedules efficiently. It features a responsive design, real-time form handling, and automated email notifications for a smooth and user-friendly experience.',
    category: 'SaaS',
    featured: false,
  ...
  {
    id: 'AI-IVoice-agent',
    title: 'AI-IVoice-agent',
    subtitle: 'Intelligent Voice Assistant for Real-Time Conversations',
    description: 'An AI-powered voice agent built using Python, Streamlit, Groq API, ElevenLabs, and Whisper API. The system enables real-time speech-to-text and text-to-speech interactions, allowing users to communicate naturally with AI. It delivers fast, accurate responses with a smooth and interactive voice experience through an intuitive Streamlit interface.',
    category: 'AI-Project',
    featured: false,
    ...
    videoUrl:  '<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7410593385926893569?compact=1" height="399" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>',
    year: '2025',
    status: 'Live',
  },
  {

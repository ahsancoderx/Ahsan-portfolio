...
const ABOUT_CSS = `
  ...
  @keyframes revealLeft   { from{ opacity:0; transform:translateX(-52px); } to{ opacity:1; transform:none; } }
  @keyframes revealRight  { from{ opacity:0; transform:translateX(52px); }  to{ opacity:1; transform:none; } }
  ...
  return (
    <Box className={`ab-sr-up ab-d${delay}`} sx={{
      ...
      <Box sx={{
        ...
        background:'rgba(234,0,42,.15)', filter:'blur(20px)',
      }}/>
      <Typography sx={{
        ...
        <Box
          ...
          sx={{
            ...
            '&::after':{
              ...
              width:'4px', background:'#fff', borderRadius:'4px', opacity:.7,
            }
          }}
        />
      </Box>
...
export default function AboutSection() {
  ...
  // trigger counters & skill bars when visible
  useEffect(() => {
    ...
    <>
      ...
      <Box id="about" sx={{
        ...
        <Box sx={{
          ...
          background:`
            radial-gradient(ellipse 55% 50% at 25% 60%, rgba(234,0,42,.11) 0%, transparent 60%),
            radial-gradient(ellipse 40% 40% at 80% 30%, rgba(234,0,42,.07) 0%, transparent 55%)
          `,
        }}/>

        {/* ── Grid texture overlay ── */}
        <Box sx={{
          position:'absolute', inset:0, zIndex:0, opacity:.03,
          backgroundImage:`
            linear-gradient(rgba(234,0,42,.8) 1px, transparent 1px),
            linear-gradient(90deg, rgba(234,0,42,.8) 1px, transparent 1px)
          `,
        ...
        <Box sx={{
          position:'absolute', left:{ xs:16, md:32 }, top:'15%', bottom:'15%',
          width:'1px', zIndex:0,
          background:'linear-gradient(to bottom, transparent, rgba(234,0,42,.4) 30%, rgba(234,0,42,.4) 70%, transparent)',
        }}/>
        ...
        <Container sx={{ position:'relative', zIndex:2, maxWidth:'1200px !important' }}>
          ...
          <Box sx={{
            ...
            <Box className="ab-sr-left ab-d1" sx={{ flex:'0 0 auto', width:{ xs:'100%', md:380 } }}>
              <Box sx={{
                ...
                '&::before':{
                  ...
                  inset:'-8px', borderRadius:'20px',
                  background:'linear-gradient(135deg,rgba(234,0,42,.5) 0%,transparent 50%,rgba(234,0,42,.3) 100%)',
                ...
                <Box sx={{
                  ...
                  <Box sx={{
                    ...
                    border:'1px solid rgba(234,0,42,.5)',
                    borderRadius:'30px',
            ...
            <Box sx={{ flex:1, minWidth:0 }}>
              ...
              <Typography className="ab-sr-right ab-d1" sx={{
                ...
                background:'linear-gradient(90deg,#fff 35%,#EA002A 85%)',
                backgroundSize:'200% auto',
                WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent',
                animation:'shimmerText 5s linear infinite',
                mb:2,
              ...
              <Typography className="ab-sr-right ab-d2" sx={{
              ...
              {[
                ...
                <Box key={item.label} className={`ab-sr-right ab-d${i+2}`} sx={{
                  ...
                  <Typography sx={{
                    color:'#EA002A', fontFamily:"'DM Sans'", fontWeight:700,
                    fontSize:'.82rem', textTransform:'uppercase', letterSpacing:'1.5px',
                    minWidth:72, pt:.1,
                  }}>
                    {item.label}
                  </Typography>
              ...
              <Box ref={skillsRef}>
                <Typography className="ab-sr-right ab-d2" sx={{
                  fontFamily:"'Syne'", fontWeight:700, color:'#fff',
                  fontSize:'1.1rem', mb:2.5, letterSpacing:'.5px',
                }}>
                  Technical Skills
                </Typography>
                {SKILLS.map((s, i) => (
                  <SkillBar key={s.label} skill={s} started={skillsStarted} delay={Math.min(i+1,6)} />
                ))}
              </Box>
            </Box>
          </Box>
          ...
          >
            {STATS.map((s, i) => (
              <StatCard key={s.label} stat={s} started={statsStarted} delay={Math.min(i+1,6)} />
            ))}
          </Box>
        </Container>
